...
// Original filename: src/sys/client_test.go
...
// when none of -t / $VAULT_TOKEN / ~/.vault-token are available. This is
// the only part of the sys package that doesn't require a live Vault
// server to exercise: every other method here (EnableKVengine,
// DisableKVengine, ListMounts) talks to the Vault API directly.
